      ...
      <section className="bg-slate-900 text-white py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <h1 className="text-4xl sm:text-5xl font-extrabold tracking-tight mb-6">
            Variable DC Power Supply: <span className="text-amber-400">2026 Workbench Guide</span>
          </h1>
      ...
      <section className="bg-white py-16 border-t border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
           <div className="flex justify-between items-end mb-8">
              ...
              <Link to="/variable-power-supplies" className="text-slate-700 hover:text-slate-900 font-medium text-sm flex items-center border-b border-transparent hover:border-slate-900 transition-all">
                View All <ArrowRight className="w-4 h-4 ml-1" />
              </Link>
           </div>
           <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {VOLTAGE_PAGES.slice(0,3).map(config => (
                 <Link key={config.slug} to={config.slug} className="group block bg-white p-6 rounded-sm shadow-sm hover:border-slate-400 transition-all border border-slate-200">
